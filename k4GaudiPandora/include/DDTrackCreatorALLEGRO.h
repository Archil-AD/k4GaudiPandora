...
public:
     ...
     */
     pandora::StatusCode CreateTracks(const std::vector<edm4hep::Track>& tracks);
...
protected:
    ...
    virtual bool PassesQualityCuts(const edm4hep::Track& pTrack, const PandoraApi::Track::Parameters &trackParameters) const;
     ...
     */
    int GetNVertexHits(const edm4hep::Track& pTrack) const;
     ...
     */
    int GetNDchHits(const edm4hep::Track& pTrack) const;
     ...
     */
    int GetNSiWrapperHits(const edm4hep::Track& pTrack) const;
     ...
     *  @param  trackParameters the track parameters
     */
    virtual void TrackReachesECAL(const edm4hep::Track& pTrack, PandoraApi::Track::Parameters &trackParameters) const;
     ...
     *  @param  trackParameters the track parameters
     */
    virtual void DefineTrackPfoUsage(const edm4hep::Track& pTrack, PandoraApi::Track::Parameters &trackParameters) const;
     ...
     */
    virtual void GetTrackStatesAtCalo(edm4hep::Track const& track, lc_content::LCTrackParameters& trackParameters) override;
